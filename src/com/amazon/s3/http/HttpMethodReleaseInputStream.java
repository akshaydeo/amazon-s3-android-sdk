...
public class HttpMethodReleaseInputStream extends InputStream {
	private static final String TAG = "###HttpMethodInputReleaseInputStream###";
	 ...
	 *            be wrapped.
	 */
	public HttpMethodReleaseInputStream(
		...
		try {
			...
			Log.w(TAG, "Unable to obtain HttpMethod's response data stream", e);
	...
	public void close() throws IOException {
		if (!alreadyReleased) {
			...
			Log.d(TAG,
					"Released HttpMethod as its response data stream is closed");
	...
	protected void finalize() throws Throwable {
		if (!alreadyReleased) {
			...
			Log.w(TAG,
					"Attempting to release HttpMethod in finalize() as its response data stream has gone out of scope. "
