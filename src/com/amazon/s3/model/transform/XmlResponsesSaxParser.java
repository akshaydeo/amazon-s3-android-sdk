package com.amazon.s3.model.transform;
...
import com.amazon.s3.internal.ObjectExpirationResult;
import com.amazon.s3.internal.ServerSideEncryptionResult;
...
import com.amazon.s3.model.BucketLifecycleConfiguration.Rule;
import com.amazon.s3.model.BucketLifecycleConfiguration.Transition;
import com.amazon.s3.model.BucketLoggingConfiguration;
import com.amazon.s3.model.BucketNotificationConfiguration;
import com.amazon.s3.model.BucketNotificationConfiguration.TopicConfiguration;
...
import com.amazon.s3.model.CORSRule;
import com.amazon.s3.model.CORSRule.AllowedMethods;
import com.amazon.s3.model.CanonicalGrantee;
import com.amazon.s3.model.CompleteMultipartUploadResult;
import com.amazon.s3.model.DeleteObjectsResponse;
import com.amazon.s3.model.DeleteObjectsResult.DeletedObject;
import com.amazon.s3.model.EmailAddressGrantee;
import com.amazon.s3.model.Grantee;
import com.amazon.s3.model.GroupGrantee;
import com.amazon.s3.model.InitiateMultipartUploadResult;
import com.amazon.s3.model.MultiObjectDeleteException;
import com.amazon.s3.model.MultiObjectDeleteException.DeleteError;
import com.amazon.s3.model.MultipartUpload;
...
import com.amazon.s3.model.PartSummary;
import com.amazon.s3.model.Permission;
import com.amazon.s3.model.RedirectRule;
import com.amazon.s3.model.RoutingRule;
import com.amazon.s3.model.RoutingRuleCondition;
import com.amazon.s3.model.S3ObjectSummary;
import com.amazon.s3.model.S3VersionSummary;
import com.amazon.s3.model.StorageClass;
import com.amazon.s3.model.TagSet;
...
public class XmlResponsesSaxParser {
	private static final String TAG = "###XmlResponseSaxParser###";
	...
	protected InputStream sanitizeXmlDocument(DefaultHandler handler,
		...
		if (!sanitizeXmlDocument) {
			...
			Log.d(TAG, "Sanitizing XML document destined for handler "
					+ handler.getClass());
	...
	private int parseInt(String s) {
		try {
			...
			Log.e(TAG, "Unable to parse integer value '" + s + "'", nfe);
		}
	...
	private long parseLong(String s) {
		try {
			...
			Log.e(TAG, "Unable to parse long value '" + s + "'", nfe);
		}
	...
	public class ListBucketHandler extends DefaultHandler {
		...
		public ObjectListing getObjectListing() {
			...
			if (nextMarker != null) {
				...
				if (objectListing.getObjectSummaries().isEmpty() == false) {
					...
					Log.e(TAG,
							"S3 response indicates truncated results, but contains no object summaries or common prefixes.");
				}
		...
		public String getMarkerForNextListing() {
			if (listingTruncated) {
				if (nextMarker != null) {
					...
					Log.w(TAG,
							"Unable to find Next Marker or Last Key for truncated listing");
		...
		public void endElement(String uri, String name, String qName) {
			...
			if (name.equals("Name")) {
				...
				Log.d(TAG, "Examining listing for bucket: " + bucketName);
	...
	public class ListVersionsHandler extends DefaultHandler {
		...
		public void startElement(String uri, String name, String qName,
			...
			if (name.equals("ListVersionsResult")) {
				...
				Log.w(TAG, "Ignoring unexpected tag <" + name + ">");
			}
			text.setLength(0);
		}
	...
	public class DeleteObjectsHandler extends DefaultHandler {
		...
		private List<DeletedObject> deletedObjects = new LinkedList<DeletedObject>();
