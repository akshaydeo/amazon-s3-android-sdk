...
public class TimingInfo {
	...
	/**
	 * Returns the time, in epoch milliseconds, at which this timing period
	 * started.
	 * 
	 * @return the time, in epoch milliseconds, at which this timing period
	 *         started.
	 */
	...
	public void addSubMeasurement(String subMeasurementName,
		...
		List<TimingInfo> timings = subMeasurementsByName
				.get(subMeasurementName);
		if (timings == null) {
	...
	public TimingInfo getLastSubMeasurement(String subMeasurementName) {
		...
		return getSubMeasurement(subMeasurementName,
				subMeasurementsByName.size() - 1);
	}
